...
class StudentRecordManagementSystem {
 ...
 private HashMap<Integer, Integer> idIndexMap; // id -> index in ArrayList (fast lookup) public StudentRecordManagementSystem() {
...
public class Main {
 ...
 int age = sc.nextInt();
 sc.nextLine(); System.out.print("Enter new Course (leave blank to skip): ");
 String course = sc.nextLine();
